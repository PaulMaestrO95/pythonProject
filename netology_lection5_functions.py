...
p - показать имя, которому принадлежит номер документа 
s - показать номер полки, на котором лежит номер документа
l - показать список документов, содержащихся в списке documents
